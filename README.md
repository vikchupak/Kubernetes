...
**Container orchestration** tool(system). Helps to **manage** containerized applications like scaling, deploing, restarting, re-scheduling. **Without it we would have to track and handle all this yourself manually.**
